...
const defaultCrawlers: Crawler[] = [
  ...
  { name: "Claude-SearchBot (Anthropic)", userAgent: "Claude-SearchBot", category: "ai", allowed: true },
  { name: "Claude-User (Anthropic)", userAgent: "Claude-User", category: "ai", allowed: true },
