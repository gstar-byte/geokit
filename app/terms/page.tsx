  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16">
      ...
      <div className="space-y-8 text-base text-gray-500 dark:text-gray-400 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">2. Permitted Use &amp; License</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">3. Disclaimer of Warranties</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">5. Termination</h2>
          <p>
