  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16">
      ...
      <div className="space-y-8 text-base text-gray-500 dark:text-gray-400 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">2. Data We Process</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">3. Third-Party Integrations</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">5. Security of Data</h2>
          <p>
